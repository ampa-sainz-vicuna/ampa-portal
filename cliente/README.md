...
| `SuiteMembers` | Quién hay aquí: `all()` da las personas activas con algún rol en esta aplicación (`Member`: correo de la cuenta, nombre y roles), por nombre; `has($correo)` dice si alguien es de aquí. Desde la 0.1.1. |
